...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
                    ...
                    <div class="main-slider">
                        <div class="slides">
                            <div class="timeline-item item swin-transition">
                                <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2000</span></div><img src="images/timeline/timeline-1.jpg" alt="fooday" class="img img-responsive">
                            </div>
                            <div class="timeline-item item swin-transition">
                                <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2002</span></div><img src="images/timeline/timeline-2.jpg" alt="fooday" class="img img-responsive">
                            </div>
                            <div class="timeline-item item swin-transition">
                                <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2004</span></div><img src="images/timeline/timeline-3.jpg" alt="fooday" class="img img-responsive">
                            </div>
                            <div class="timeline-item item swin-transition">
                                <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2008</span></div><img src="images/timeline/timeline-4.jpg" alt="fooday" class="img img-responsive">
                            </div>
                            <div class="timeline-item item swin-transition">
                                <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2012</span></div><img src="images/timeline/timeline-5.jpg" alt="fooday" class="img img-responsive">
                            </div>
                            <div class="timeline-item item swin-transition">
                                <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2016</span></div><img src="images/timeline/timeline-6.jpg" alt="fooday" class="img img-responsive">
                            </div>
                            <div class="timeline-item item swin-transition">
                                <div class="timeline-item-wrap"><span class="timeline-year swin-transition">2017</span></div><img src="images/timeline/timeline-7.jpg" alt="fooday" class="img img-responsive">
                            </div>
                        </div>
                    </div>
        ...
        <section data-bottom-top="background-position: 50% 50px;" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -150px;" class="ab-testimonial-section padding-top-100 padding-bottom-100">
            <div class="container"><img src="images/background/ab_team_01.png" alt="" class="img-left img-bg img-deco img-responsive">
                <div class="row">
                            ...
                            <div class="main-slider flexslider">
                                <div class="slides">
                                    <div class="testi-item item"><i class="testi-icon fa fa-quote-left"></i>
                                        ...
                                        </div><img src="images/testi/testi-signal.png" alt="" class="testi-signal">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="swin-sc sc-featured-box item wow fadeInUp"><img src="images/featured-box-bg-1.jpg" alt="fooday" class="box-bg">
                                    <div class="box-inner">
                                        ...
                                        <div class="showcase"><img src="images/feature-box-bg.jpg" alt="" class="img-responsive img-showcase">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div data-wow-delay="0.5s" class="swin-sc sc-featured-box item wow fadeInUp"><img src="images/featured-box-bg-1.jpg" alt="fooday" class="box-bg">
                                    <div class="box-inner">
                                        <h4 class="box-title">VARIOUS DRINK</h4>
                                        <div class="box-content">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</div>
                                        <div class="btn-wrap text-center"><a href="javascript:void(0)" class="btn swin-btn"><span>Read More</span></a></div>
                                        <div class="showcase"><img src="images/feature-box-bg-2.jpg" alt="" class="img-responsive img-showcase">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div data-wow-delay="1s" class="swin-sc sc-featured-box item wow fadeInUp"><img src="images/featured-box-bg-1.jpg" alt="fooday" class="box-bg">
                                    <div class="box-inner">
                                        <h4 class="box-title">EXCLUSIVE DISHES</h4>
                                        <div class="box-content">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</div>
                                        <div class="btn-wrap text-center"><a href="javascript:void(0)" class="btn swin-btn"><span>Read More</span></a></div>
                                        <div class="showcase"><img src="images/feature-box-bg-3.jpg" alt="" class="img-responsive img-showcase">
        ...
        <section class="partner-section-03 padding-top-100 padding-bottom-100">
            <div class="container">
                <div data-item="6" class="swin-sc swin-sc-partner">
                    <div class="main-slider">
                        <div class="slides">
                            <div class="item"><img src="images/partner/partner-01.png" alt="fooday" class="img img-responsive"></div>
                            <div class="item"><img src="images/partner/partner-02.png" alt="fooday" class="img img-responsive"></div>
                            <div class="item"><img src="images/partner/partner-03.png" alt="fooday" class="img img-responsive"></div>
                            <div class="item"><img src="images/partner/partner-04.png" alt="fooday" class="img img-responsive"></div>
                            <div class="item"><img src="images/partner/partner-01.png" alt="fooday" class="img img-responsive"></div>
                            <div class="item"><img src="images/partner/partner-02.png" alt="fooday" class="img img-responsive"></div>
                            <div class="item"><img src="images/partner/partner-03.png" alt="fooday" class="img img-responsive"></div>
                        </div>
        ...
        <section class="counter-section-03 padding-top-100 padding-bottom-100">
            <div class="container"><img src="images/background/vegetable_01.png" alt="" class="img-left img-bg img-responsive"><img src="images/background/vegetable_02.png" alt="" class="img-right img-bg img-responsive">
                <div class="swin-sc swin-sc-counter">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="counter-avatar"><img src="images/counter-1.png" alt="fooday" class="img img-responsive"></div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="counter-avatar"><img src="images/counter-2.png" alt="fooday" class="img img-responsive"></div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="counter-avatar"><img src="images/counter-3.png" alt="fooday" class="img img-responsive"></div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="counter-avatar"><img src="images/counter-4.png" alt="fooday" class="img img-responsive"></div>
                        </div>
                    </div>
                </div>
            </div>
